...
class SurfaceExport BlendCurve : public Part::Spline
{
    PROPERTY_HEADER_WITH_OVERRIDE(Surface::BlendCurve);

public:
	BlendCurve();

    App::PropertyLinkSub StartEdge;
    App::PropertyInteger StartParameter;
    App::PropertyInteger StartContinuity;
    App::PropertyFloat StartSize;

    App::PropertyLinkSub EndEdge;
    App::PropertyInteger EndParameter;
